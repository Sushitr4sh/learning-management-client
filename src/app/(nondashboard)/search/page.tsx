    ...
    >
      ...
      <div className="search__content">
        ...
        {selectedCourse && (
          ...
          >
            {/* Selected course is not going to be used in any other place, you don't need to put it in the component folder, instead it can be put in the same folder as the page file */}
            <SelectedCourse
